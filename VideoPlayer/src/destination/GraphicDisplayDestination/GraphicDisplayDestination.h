...
typedef struct ChangeEffectRequest
{
    VideoPlayerEffect       effectType;
    bool                    isValid;
} ChangeEffectRequest;
...
public:
    ...
    VOID SetEffect( VideoPlayerEffect type );
...
private:
    ...
    int64                           m_progress;
    ChangeEffectRequest             m_changeEffectRequest;
    ChangeEffectRequest*            m_pChangeEffectRequest;
    Graphic::GraphicFilter*         m_pCurrentFilter;
};
