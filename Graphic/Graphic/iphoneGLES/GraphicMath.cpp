...
namespace Graphic
{
    ...
    void MatrixFrustum( Matrix16* result, FLOAT32 left, FLOAT32 right, FLOAT32 bottom, FLOAT32 top, FLOAT32 near, FLOAT32 far )
    {
        ...
        result->m[0][0] = 2.0f * near / deltaX;
        result->m[1][0] = result->m[2][0] = result->m[3][0] = 0.0f;

        result->m[1][1] = 2.0f * near / deltaY;
        ...
        result->m[3][2] = - 2 * near * far / deltaZ;
    ...
    {
        FLOAT32 x2 = quaternions->x * quaternions->x;
        FLOAT32 y2 = quaternions->y * quaternions->y;
        FLOAT32 z2 = quaternions->z * quaternions->z;
        FLOAT32 xy = quaternions->x * quaternions->y;
        FLOAT32 xz = quaternions->x * quaternions->z;
        FLOAT32 yz = quaternions->y * quaternions->z;
        FLOAT32 wx = quaternions->w * quaternions->x;
        FLOAT32 wy = quaternions->w * quaternions->y;
        FLOAT32 wz = quaternions->w * quaternions->z;
        result->m[0][0] = 1.f - 2.f * ( y2 + z2 );
        result->m[0][1] = 2.f * ( xy - wz );
        result->m[0][2] = 2.f * ( xz + wy );
        result->m[0][3] = 0.f;
        result->m[1][0] = 2.f * ( xy + wz );
        result->m[1][1] = 1.f - 2.f * ( x2 + z2 );
        result->m[1][2] = 2.f * ( yz - wx );
        result->m[1][3] = 0.f;
        result->m[2][0] = 2.f * ( xz - wy );
        result->m[2][1] = 2.f * ( yz + wx );
        result->m[2][2] = 1.f - 2.f * ( x2 + y2 );
        result->m[2][3] = 0.f;
        result->m[3][0] = 0.f;
        result->m[3][1] = 0.f;
        result->m[3][2] = 0.f;
